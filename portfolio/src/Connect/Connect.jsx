...
const Connect = () => {
  return (
    <div className="bg-white flex flex-col spcace-x-2 m-2 mt-4 mb-4 rounded-lg shadow-md p-4 animate-slideIn border-2 shadow-slate-600">
      <div className="flex justify-center space-x-6 mb-6 animate-slideIn">
        ...
        <a href="https://github.com/SaiDeepakKumarReddy" target="_blank" rel="noopener noreferrer">
